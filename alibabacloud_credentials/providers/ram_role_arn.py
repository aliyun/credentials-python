...
from . import HttpOptions, StaticAKCredentialsProvider, StaticSTSCredentialsProvider
...
class RamRoleArnCredentialsProvider(ICredentialsProvider):
    ...
    def __init__(self, *,
        ...
        if self._duration_seconds is None or self._duration_seconds < 900:
    ...
    def _refresh_credentials(self) -> RefreshResult[Credentials]:
        ...
        if pre_credentials is None:
            raise CredentialException('unable to load original credentials from the providers in RAM role arn')
